...
public class NewMessageReceivedPublish extends AbstractPublish {
    ...
    public NewMessageReceivedPublish(String userXmppAddress, String username, String message, String buttonLabel) {
