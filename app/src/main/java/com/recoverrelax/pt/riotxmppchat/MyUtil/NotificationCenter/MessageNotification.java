    ...
    public void sendMessageNotification(){
        ...
        riotXmppRepository.getNotificationByUser(userXmppAddress)
                ...
                .flatMap(targetUserName -> {
                    ...
                    if (isPausedOrClosed()) {
                        return hSendSystemNotification(targetUserName + " says:", message, MESSAGE_NOTIFICATION_DRAWABLE, MESSAGE_NOTIFICATION_ID,
                         ...
                         */
                        LOGI("12", "Aqui!2");
                        MainApplication.getInstance().getBusInstance().post(MessageNotification.this);
