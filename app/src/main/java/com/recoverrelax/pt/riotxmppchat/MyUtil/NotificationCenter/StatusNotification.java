        ...
        riotXmppRepository.getNotificationByUser(userXmppAddress)
                ...
                .flatMap(notification -> {
                    if (isPausedOrClosed()) {
                        ...
                        return hSendSystemNotification(username, systemNotificationMessage, notificationDrawable, STATUS_NOTIFICATION_ID,
                                statusPermission);
                    } else {
                        MainApplication.getInstance().getBusInstance().post(StatusNotification.this);
